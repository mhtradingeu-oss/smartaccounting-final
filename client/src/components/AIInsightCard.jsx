...
function AIInsightCard({
  ...
  return (
    <section
      className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm transition-all duration-300 dark:border-gray-800 dark:bg-gray-900/80 dark:shadow-none"
      role="region"
    ...
    >
      <div className="flex items-center justify-between mb-2">
        <div className="flex items-center gap-2">
          ...
          <span
            className="text-sm font-semibold text-blue-700 uppercase tracking-wide dark:text-blue-300"
            id="ai-insight-label"
          >
            AI Insight
          </span>
      ...
      <div className="mb-2">
        <span className="font-bold text-gray-950 dark:text-white" aria-label="Insight type">
          {type}
        </span>
        <p className="mt-1 text-gray-800 dark:text-gray-100" aria-live="polite">
          {summary}
        </p>
      </div>
      <AIMetadataLine
