    ...
    >
      <div className="flex items-center justify-between gap-2 mb-2">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-semibold text-blue-700 dark:text-blue-300" id="ai-suggestion-label">
            AI Insight
          </span>
        </div>
      ...
      <div className="mb-2 text-gray-800 dark:text-gray-100" aria-live="polite">
