...
const variantClasses = {
  ...
  secondary:
    'bg-gray-100 text-gray-900 hover:bg-gray-200 border border-transparent focus-visible:ring-primary-500 dark:bg-gray-800 dark:text-gray-100 dark:hover:bg-gray-700 dark:border-gray-700',
  danger: 'bg-red-600 text-white hover:bg-red-700 focus-visible:ring-red-500 dark:bg-red-500 dark:hover:bg-red-400',
  outline:
    'border border-gray-300 bg-transparent text-gray-900 hover:bg-gray-50 focus-visible:ring-primary-500 dark:border-gray-600 dark:text-gray-100 dark:hover:bg-gray-800',
  ghost:
    'bg-transparent text-gray-900 hover:bg-gray-100 focus-visible:ring-primary-500 dark:text-gray-100 dark:hover:bg-gray-800',
};
