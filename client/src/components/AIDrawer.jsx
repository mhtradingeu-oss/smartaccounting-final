    ...
    >
      <div className="flex items-center justify-between p-4 border-b">
        <div className="flex items-center gap-2">
          {/* <AIBadge label="AI-generated" tooltip="These insights are generated by AI." /> */}
      ...
      <div
        className="p-4 border-t text-xs text-gray-700 bg-gray-50"
        aria-label="Advisory disclaimer"
      >
        <span className="font-semibold">For advisory purposes only — No actions executed</span>
        <span className="block mt-1 text-gray-600">
          These insights are provided to support professional decision-making and do not trigger any
          actions or changes. Please review the context and consult with your team as needed.
        </span>
      </div>
    </aside>
  );
